...
class MinesweeperAI():
            ...
            if len(sentence.cells) == sentence.count:
                ...
                if sentence.count == 0:
                    ...
                    for cell in cells:
                        self.mark_safe(cell)
                    del sentence
        # Check for inference based on the subset explained in background
    ...
    def make_random_move(self):
        ...
        Should choose randomly among cells that:
            1. Have not already been choosen, and
